...
import com.dialect.identity.SQLiteDialectIdentityColumnSupport;
	...
	private static class SQLiteUniqueDelegate extends DefaultUniqueDelegate {
		...
		public String getTableCreationUniqueConstraintsFragment(Table table, SqlStringGenerationContext context) {
			...
			while (iter.hasNext()) {
				...
				builder.append(", CONSTRAINT ").append(dialect.quote(key.getName())).append(" ")
						.append(uniqueConstraintSql(key));
			}
